...
describe("antwerpen", () => {
    describe("coordinate", () => {
            ...
            features: [
                {
                    ...
                    geometry: {
                        paths: [
                            [
                                [4.3848554323514879, 51.227278487792972],
                                [4.3895442044054285, 51.227195400823213],
                                [4.3917237671597773, 51.227167156757098],
                                [4.3918285394528542, 51.227165805465631],
                                [4.3924810363382152, 51.2271573402953],
                                [4.3936977052640982, 51.22714154188219],
                                [4.3994721187998778, 51.227066408385575],
                                [4.4003689835059498, 51.227052576330244],
                                [4.4009694410881295, 51.227043314518596],
                                [4.401107323266479, 51.227041181775775],
                                [4.4012152870674557, 51.22703951567123],
                                [4.4012913140789527, 51.227038343819224],
                                [4.4014682332562938, 51.227035615434922],
                                [4.4015360148122902, 51.227034571591972],
                                [4.4015997308983197, 51.227033582793574],
                                [4.4016932508290285, 51.22703214505767],
                                [4.4033552611202484, 51.226982620136724],
                                [4.4033611874544274, 51.226982438600345],
                                [4.4034182460357885, 51.226980327263632],
                                [4.4034222684755093, 51.226980173258561],
                                [4.4050525869508652, 51.22691961421696],
                                [4.4051506856344993, 51.226915970164491],
                                [4.4052012451731812, 51.226914093703229],
                                [4.4053731208704754, 51.226906543296323],
                                [4.4055590248377472, 51.226898376982945],
                                [4.4070406817265333, 51.226965301600067],
                                [4.4070747673682051, 51.226966836357889],
                                [4.4071648709098259, 51.226971633347901],
                                [4.4093086792660117, 51.22708573134193],
                                [4.409558075845772, 51.227099000794972],
                                [4.4097718151714878, 51.227114214803777],
                                [4.410167669930793, 51.227142387859203],
                            ],
                        ],
                    },
                },
        ...
        describe("createService", () => {
            ...
            it("should return an address when no park", (done) => {
            ...
            it("should return a bicycle route location when no park, street was found + correct properties", (done) => {
                var stub = sinon.stub(service, "getPointWithin");
                stub.onFirstCall().resolves();

                var stub2 = sinon.stub(service, "getPointNearby");
                stub2.onFirstCall().resolves(dummyBicycleRouteResult);
            ...
            it("should return a regional route location when no park, address or bicycle route was found + correct properties", (done) => {
                var stub = sinon.stub(service, "getPointWithin");
                stub.resolves();
                ...
                stub3.onSecondCall().resolves(dummyRegionalRoad);
